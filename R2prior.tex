...
log fit-ratio is estimated to be about $0$, which indicates a good fit of the
model to the data. It would be safe to conclude that the OLS estimator
considerably \emph{overfits} the data since there are only $24$ observations
